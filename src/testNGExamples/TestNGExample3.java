...
public class TestNGExample3 {
	...
	@Test(description="This TC is for login",enabled=true)
	public void login()
	{
	...
	@Test(description="This TC is for Logout",enabled=true)
	public void logout()
	{
	...
	@Test(description="This TC is for Initialize",enabled=true)
