...
public class DataProviderFromExcelMultipleBrowser {
	
	String data[][];
	
	static WebDriver driver;
	
	DataProviderFromExcelMultipleBrowser d;
	...
	public void launchBrowser(String browser,String url)
	{
		...
		if(browser.equals("chrome"))
		{
			...
			DataProviderFromExcelMultipleBrowser.driver = new ChromeDriver();
		...
		else if(browser.equals("firefox"))
		{
			...
			DataProviderFromExcelMultipleBrowser.driver = new FirefoxDriver();
	...
	public void Login(String user,String pwd,String browser, String url) throws Exception
	{
		d = new DataProviderFromExcelMultipleBrowser();
